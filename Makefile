#############################################################################
# Makefile for building: risi
# Generated by qmake (2.01a) (Qt 4.4.0) on: Mon Nov 5 22:57:39 2007
# Project:  risi.pro
# Template: subdirs
# Command: /home/acidass/projectz/qt/bin/qmake -unix -o Makefile risi.pro
#############################################################################

first: make_default
MAKEFILE      = Makefile
QMAKE         = /home/acidass/projectz/qt/bin/qmake
DEL_FILE      = rm -f
...
Makefile: risi.pro  ../../../qt/mkspecs/default/qmake.conf ../../../qt/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix -o Makefile risi.pro
